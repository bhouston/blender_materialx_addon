...
class DocumentManager:
    ...
    def create_document(self, name: str, version: str = "1.39") -> mx.Document:
        ...
        """
        with monitor_performance(self.logger, "create_document", {"name": name, "version": version}):
            try:
                ...
                self._document_metadata[name] = {
                    'version': version,
                    'created_at': mx.getCurrentTimeString(),
                    'node_count': 0,
                    'material_count': 0
                }
    ...
    def add_material(self, doc: mx.Document, material_name: str, 
        ...
        """
        with monitor_performance(self.logger, "add_material", {"name": material_name, "type": material_type}):
            try:
    ...
    def add_node(self, doc: mx.Document, node_name: str, node_type: str, 
        ...
        """
        with monitor_performance(self.logger, "add_node", {"name": node_name, "type": node_type}):
            try:
    ...
    def add_input(self, node: mx.Node, input_name: str, input_type: str = "float",
                  value: Optional[Union[str, float, List[float]]] = None) -> mx.Input:
        """
    ...
    def add_output(self, node: mx.Node, output_name: str, output_type: str = "color3") -> mx.Output:
        """
    ...
    def optimize_document(self, doc: mx.Document) -> bool:
        ...
        """
        with monitor_performance(self.logger, "optimize_document"):
            try:
                # Remove unused nodes
                unused_nodes = []
    ...
    def validate_document(self, doc: mx.Document) -> Dict[str, Any]:
        ...
        """
        with monitor_performance(self.logger, "validate_document"):
            try:
                # Basic validation
                errors = []
                warnings = []
